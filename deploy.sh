...
# main config
PLUGINSLUG="wp-copyright-protection"
CURRENTDIR=`pwd`
MAINFILE="wp-copyright-protection.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="dave.ligthart" # your svn username
